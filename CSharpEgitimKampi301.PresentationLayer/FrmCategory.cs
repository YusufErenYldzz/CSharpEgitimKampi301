...
namespace CSharpEgitimKampi301.PresentationLayer
{
    public partial class FrmCategory: Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Kategori Eklendi","Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void btnGetById_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Kategori Getirildi", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
            dataGridView1.AutoGenerateColumns = true;
            dataGridView1.DataSource = new List<Category> { categoryValues };
